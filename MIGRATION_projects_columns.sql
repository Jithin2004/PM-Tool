...
ALTER TABLE projects ADD COLUMN IF NOT EXISTS pert_best NUMERIC DEFAULT 0;
ALTER TABLE projects ADD COLUMN IF NOT EXISTS pert_likely NUMERIC DEFAULT 0;
ALTER TABLE projects ADD COLUMN IF NOT EXISTS pert_worst NUMERIC DEFAULT 0;
