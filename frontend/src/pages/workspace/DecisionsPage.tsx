                        ...
                        <div key={idx} className="flex items-center justify-between p-2 rounded-lg bg-surface-2 border border-border-subtle">
                          ...
                          {isPending && isCurrentStep && userHasAuthority && canCoordinate && (
                            <button
                              ...
                              className="px-2 py-1 bg-signal-safe text-[var(--pm-text)] text-[var(--text-primary)] text-[9px] font-bold uppercase rounded hover:brightness-115"
                            >
                              Approve
                            </button>
                          )}
                ...
                <div>
                  ...
                  <div className="flex gap-2">
                    ...
                    <button
                      ...
                      className="px-3 py-1 bg-accent-primary text-[var(--pm-text)] text-[var(--text-primary)] text-[9px] font-bold uppercase rounded hover:brightness-110"
                    >
                      Reassign
                    </button>
                  </div>
                          ...
                          {mit.status === 'identified' && (canParticipate && isOwner) && (
                            <div className="flex gap-1">
                              <button
                                ...
                                className="p-1 bg-signal-safe rounded text-[var(--pm-text)] text-[var(--text-primary)]"
                              >
                                <Check className="w-3.5 h-3.5" />
                              </button>
                              <button
                                onClick={() => handleResolveMitigation(selectedDecision.id, mit.id, false)}
                                className="p-1 bg-signal-critical rounded text-[var(--pm-text)] text-[var(--text-primary)]"
                              >
                ...
                {canCoordinate && selectedDecision.approvalStatus !== 'approved' && (
                  <div className="flex gap-2 mb-3">
                    ...
                    <button
                      ...
                      className="px-3 py-1 bg-rose-500 text-[var(--pm-text)] text-[var(--text-primary)] text-[9px] font-bold uppercase rounded hover:brightness-110"
                    >
                      Escalate
                    </button>
                  </div>
                  ...
                  <div className="flex flex-col gap-2 mb-3 bg-surface-2 p-3 rounded-lg border border-border-subtle">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <button
                        ...
                        className="px-3 py-1.5 bg-purple-600 text-[var(--pm-text)] text-[var(--text-primary)] text-[9px] font-bold uppercase rounded hover:brightness-110"
                      >
                        Intervene
                      </button>
                    </div>
          ...
          <div className="relative bg-surface/80 backdrop-blur-xl border border-border/50 rounded-2xl w-full max-w-lg p-8 shadow-2xl shadow-black/50 flex flex-col gap-6 animate-in fade-in zoom-in-95 duration-200">
            ...
            <form onSubmit={handleSaveDecision} className="space-y-4">
              ...
              <div className="flex items-center gap-2 justify-end pt-3 border-t border-border mt-4">
                ...
                <button
                  type="submit"
                  className="px-4 py-2 bg-accent-primary text-[var(--pm-text)] text-[var(--text-primary)] text-xs font-bold uppercase rounded-lg hover:brightness-110"
                >
                  Save Decision
                </button>
              </div>
