          ...
          <div className="space-y-8">
            ...
            <div className="flex items-center gap-3 pt-2">
              <button
                ...
                className="px-6 py-2.5 bg-accent-primary text-[var(--pm-text)] dark:text-white text-[10px] font-medium uppercase tracking-wider hover:bg-accent-primary/90 transition-all rounded-sm shadow-sm flex items-center gap-2 cursor-pointer"
              >
