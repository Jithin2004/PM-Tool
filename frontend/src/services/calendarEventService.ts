 ...
 */
const RAW_URL = import.meta.env.VITE_CALENDAR_API_URL || 'http://localhost:5001';
const CALENDAR_API_BASE = RAW_URL.endsWith('/api/calendar') ? RAW_URL : `${RAW_URL.replace(/\/$/, '')}/api/calendar`;
