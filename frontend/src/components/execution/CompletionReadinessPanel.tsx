        ...
        <div className="p-6 space-y-8 overflow-y-auto max-h-[80vh]">
            ...
            <div className="bg-surface-elevated border border-cyan-500/30 rounded-xl p-6 shadow-lg shadow-cyan-500/10">
              ...
              {guidedStep === 3 && policy === 'enterprise' && (
                <div className="space-y-4">
                  ...
                  {missingSignoffs ? (
                    <button onClick={onRequestSignoff} className="px-4 py-2 bg-cyan-500 text-white font-bold rounded">Request Signoff</button>
                  ) : (
          ...
          <div className="flex flex-wrap gap-4 pt-4 border-t border-surface-border">
            {!readiness.isBlocker && !guidedMode && (
              <button className="px-6 py-2 bg-emerald-500 hover:bg-emerald-600 text-white font-bold rounded-md shadow-lg shadow-emerald-500/20 transition-all">
                Complete Project
              </button>
            )}
            ...
            {policy === 'enterprise' && missingSignoffs && !guidedMode && (
              <button 
                ...
                className="px-6 py-2 bg-cyan-500 hover:bg-cyan-600 text-white font-bold rounded-md shadow-lg shadow-cyan-500/20 transition-all"
              >
                Request Signoff
              </button>
            )}
              ...
              <div className="ml-auto flex items-center gap-3">
                {showOverrideConfirm ? (
                  <>
                    ...
                    <button 
                      onClick={onOverride}
                      className="px-4 py-2 border border-rose-500/50 bg-rose-500/10 text-rose-400 hover:bg-rose-500 hover:text-white text-sm font-bold rounded transition-all"
                    >
                      Confirm Override
                    </button>
                  </>
