      ...
      <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4">
        ...
        <div className="flex flex-wrap items-center gap-2 w-full lg:w-auto">
          ...
          {canAddTask && (
            <button
              onClick={onAddTask}
              className="flex items-center gap-1.5 px-4 py-2 bg-accent-primary hover:bg-accent-primary/90 text-gray-900 dark:text-white rounded-lg text-[13px] font-semibold shadow-sm transition-all active:scale-95"
            >
