    ...
    <div className="flex flex-col h-[400px]">
                ...
                {editingId === c.id ? (
                  <div className="mt-2">
                    ...
                    <div className="flex gap-2 mt-2 justify-end">
                      ...
                      <button onClick={() => handleUpdate(c.id)} disabled={isSubmitting} className="text-[9px] uppercase tracking-wide bg-accent-primary text-[var(--pm-text)] text-[var(--text-primary)] px-2 py-1 rounded">Save</button>
                    </div>
                  </div>
                ) : (
      ...
      <form onSubmit={handleSubmit} className="flex gap-2 items-end pt-2 border-t border-border-subtle">
        ...
        <button
          ...
          className="h-[60px] px-4 bg-accent-primary hover:bg-accent-primary/90 text-[var(--pm-text)] text-[var(--text-primary)] flex items-center justify-center disabled:opacity-50 transition-colors"
        >
