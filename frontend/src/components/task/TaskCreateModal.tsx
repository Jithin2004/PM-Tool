        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="pt-6 mt-4 flex justify-end gap-3 border-t border-gray-100 dark:border-white/5">
            ...
            <button
              ...
              className="px-6 py-2.5 bg-accent-primary hover:bg-accent-primary/90 text-gray-900 dark:text-white text-[11px] font-bold uppercase tracking-widest rounded-lg transition-all shadow-[0_0_15px_rgba(var(--color-accent-primary-rgb),0.3)] hover:shadow-[0_0_20px_rgba(var(--color-accent-primary-rgb),0.5)] disabled:opacity-50 disabled:shadow-none"
            >
