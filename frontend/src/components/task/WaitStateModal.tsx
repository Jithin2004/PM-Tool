...
export function WaitStateModal({ isOpen, onClose, task, onSubmit, notify }: WaitStateModalProps) {
  ...
  return (
    <div className="fixed inset-0 bg-white dark:bg-black/60 backdrop-blur-md z-[99999] flex items-center justify-center p-4">
      <motion.div
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="pt-6 mt-4 flex justify-end gap-3 border-t border-gray-100 dark:border-white/5">
            <button
              type="button"
              onClick={onClose}
            ...
            <button
              ...
              className="px-6 py-2.5 bg-amber-500 hover:bg-amber-400 text-gray-900 dark:text-white text-[11px] font-bold uppercase tracking-widest rounded-lg transition-all shadow-[0_0_15px_rgba(245,158,11,0.3)] hover:shadow-[0_0_20px_rgba(245,158,11,0.5)] disabled:opacity-50 disabled:shadow-none cursor-pointer"
            >
