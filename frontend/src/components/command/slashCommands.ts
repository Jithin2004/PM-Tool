...
export const SLASH_COMMANDS: SlashCommand[] = [
  ...
  { command: '/summarize sprint', group: 'ANALYSIS', description: 'Generate sprint summary', example: '/summarize sprint Sprint 4' },
  { command: '/find blockers', group: 'ANALYSIS', description: 'Find blocked tasks', example: '/find blockers' },
  { command: '/find overdue', group: 'ANALYSIS', description: 'Find overdue tasks', example: '/find overdue' },
  ...
  { command: '/workload', group: 'ANALYSIS', description: 'View team workload', example: '/workload' },
  { command: '/risks', group: 'ANALYSIS', description: 'View project risks', example: '/risks' },
