    ...
    <div className="w-full bg-bg border border-border-subtle rounded-sm p-4 sm:p-6 backdrop-blur-md relative overflow-hidden">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-6 border-b border-border-subtle pb-4">
        ...
        <div className="flex items-center gap-2">
          <span className="text-[9px] font-mono text-text-quaternary uppercase tracking-wider">{tasks.length} items</span>
        </div>
      </div>
      ...
      <div className="mb-6 bg-bg border border-border-subtle rounded-sm overflow-hidden">
        ...
        >
          ...
          <div className="flex items-center gap-2">
            ...
            <ChevronDown className={`w-3.5 h-3.5 text-text-quaternary transition-transform duration-200 ${projectsPanelOpen ? 'rotate-0' : '-rotate-90'}`} />
          </div>
        </button>
        ...
        {projectsPanelOpen && (
          <div className="max-h-[180px] overflow-y-auto scrollbar-thin divide-y divide-white/[0.03]">
            {projects.length === 0 ? (
              <div className="px-4 py-5 text-center text-text-quaternary text-[9px] font-mono uppercase tracking-wider">
        ...
        {isDrawerOpen && selectedTask && (
          <div className="fixed inset-0 z-[9999] flex justify-end">
            <motion.div
              ...
              className="absolute inset-0 bg-bg backdrop-blur-xs"
            />
            <motion.div
              initial={{ x: '100%' }}
              animate={{ x: 0 }}
              ...
              className="w-full max-w-md bg-[#090a0f] border-l border-border h-full relative z-10 flex flex-col text-text-primary"
            >
              <div className="p-4 border-b border-border-subtle bg-bg flex justify-between items-center">
                <div className="flex items-center gap-2">
                  <Terminal className="w-4 h-4 text-cyan-400" />
                  <span className="text-[10px] font-mono uppercase tracking-wide text-cyan-200">
              ...
              <div className="flex-1 p-5 flex items-center justify-center text-[10px] font-mono uppercase tracking-wide text-text-quaternary">
