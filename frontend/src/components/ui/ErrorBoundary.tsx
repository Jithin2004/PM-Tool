      ...
      return (
        <div className="min-h-[400px] w-full flex items-center justify-center p-6 bg-surface">
          <div className="max-w-md w-full bg-surface-2 border border-red-500/30 rounded-2xl p-8 text-center shadow-2xl relative overflow-hidden">
            ...
            {this.state.error && (
              <div className="bg-black/30 border border-border p-3 rounded-lg mb-8 text-left overflow-auto max-h-32">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
              ...
              <button
                ...
                className="w-full sm:w-auto px-6 py-2.5 bg-accent-primary hover:bg-accent-primary/90 text-white text-xs font-bold uppercase tracking-widest rounded-lg transition-colors shadow-lg shadow-accent-primary/20 flex items-center justify-center gap-2 cursor-pointer"
              >
