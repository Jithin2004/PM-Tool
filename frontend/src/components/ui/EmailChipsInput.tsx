      ...
      >
        {value.map((chip) => (
          <div key={chip.email} className="flex items-center gap-1 bg-surface-2 border border-border/60 rounded-full pl-3 pr-1 py-1 text-sm shadow-sm group">
            ...
            >
              <option value="Developer" className="bg-surface-3 text-white">Developer</option>
              <option value="PM" className="bg-surface-3 text-white">PM</option>
              <option value="Viewer" className="bg-surface-3 text-white">Viewer</option>
            </select>
            <button
              type="button"
